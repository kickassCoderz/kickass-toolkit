...
You can use `RestDataService` by importing them from our library and using directly inside of your app. Follow [quick start](/docs/data-service/quick-start#using-dataservice) to learn more.
...
<Tabs items={['npm', 'pnpm', 'yarn']}>
    ...
    <Tab>
    ```bash copy 
    pnpm add @kickass-coderz/data-service # or any other data provider
    ```
    </Tab>
    <Tab>
    ```bash copy 
    yarn add @kickass-coderz/data-service  # or any other data provider
    ```
    </Tab>

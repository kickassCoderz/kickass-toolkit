...
describe('useIntersectionObserver', () => {
    ...
    it('should render', () => {
        ...
        const { result } = renderHook(() => useIntersectionObserver(div, callbackSpy))
    ...
    it('should create IntersectionObserver instance for every hook render with different options', () => {
        ...
        renderHook(() =>
            useIntersectionObserver(div, callbackSpy, { root: div2, rootMargin: '10px 10px 10px 10px', threshold: 0.8 })
    ...
    it('should create IntersectionObserver instance after options change', () => {
        ...
        const { rerender } = renderHook(
            ({ options }: { options?: IntersectionObserverInit }) => useIntersectionObserver(div, callbackSpy, options),
            {
                initialProps: {}
            }
        )
        ...
        rerender({ options: { root: div, rootMargin: '3px 3px 3px 3px', threshold: 0.5 } })
    ...
    it('should update IntersectionObserver callback after callback change', () => {
        ...
        const { rerender } = renderHook(
            ({ callback }: { callback: IntersectionObserverCallback }) => useIntersectionObserver(div, callback),
            {
    ...
    it('should not create IntersectionObserver instance when options stay the same', () => {
        ...
        const { rerender } = renderHook(
            ({ options }: { options?: IntersectionObserverInit }) => useIntersectionObserver(div, callbackSpy, options),
            {
                initialProps: { options: { root: div, rootMargin: '3px 3px 3px 3px', threshold: 0.5 } }
            }
        )
    ...
    it('should invoke all callbacks registered to different observers', () => {
        ...
        const callbackSpy2 = jest.fn()
        renderHook(() => useIntersectionObserver(div, callbackSpy))
        renderHook(() => useIntersectionObserver(div, callbackSpy2, { threshold: 0.5 }))
    ...
    it('should cleanup on element change', () => {
        ...
        const div2 = document.createElement('div')
        const callbackSpy = jest.fn()
        const { rerender } = renderHook(({ element }) => useIntersectionObserver(element, callbackSpy), {
            initialProps: {
                element: div
            }
        })
    ...
    it('should cleanup on component unmount', () => {
        const div = document.createElement('div')
        const callbackSpy = jest.fn()
        const { unmount } = renderHook(() => useIntersectionObserver(div, callbackSpy))
